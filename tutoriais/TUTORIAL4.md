...
Declare o método "loadFromFile()", que carrega a imagem passada, ignorando o fundo. Primeiramente, deloque qualquer textura que já estivesse antes, para previnir conflitos, declare a textura que será passada para o atributo de classe que deve contê-la, depois, declare o ponteiro do tipo "SDL_Surface" para carregar a imagem passada ao método:
